    ...
    <section className="py-20 md:py-32 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div ref={textRef} className="  opacity-0 mt-8 max-w-3xl mx-auto space-y-4 text-muted-foreground">
          ...
          East Asia University of Technology is organizing the two-day Sixth International Conference on Intelligent Systems & Networks (ICISN 2026) on 21-22 March 2026. The conference will focus on Intelligent Systems and Networks, with emphasis on security considerations and the latest technologies.
          </p>
          <p className="text-justify">
